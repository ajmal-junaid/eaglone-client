    ...
    return (
      <>
        <div className="my-6 lg:my-12 container px-6 mx-auto flex flex-col lg:flex-row items-start lg:items-center justify-between pb-4 border-b border-gray-300">
          ...
          <button onClick={openModal} className="transition duration-150 ease-in-out hover:bg-indigo-600 focus:outline-none border bg-indigo-700 rounded text-white px-8 py-2 text-sm">
            Add Course
          </button>
          </div>
        </div>
                  ...
                  <tbody className="text-gray-600 text-sm font-light">
                    {courses.map((course, index) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-6 text-left whitespace-nowrap">{course.category}</td>
