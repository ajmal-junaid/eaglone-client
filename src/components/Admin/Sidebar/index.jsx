    ...
    return (
        <>
            <div className="w-full">
                {/* Navigation starts */}
                {/* Mobile */}
                <div className={show ? "w-full h-full absolute z-60  transform  translate-x-0 " : "   w-full h-full absolute z-40  transform -translate-x-full"}>
                            ...
                            <div className="px-6 pt-4">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center">
                                        ...
                                        <p className="text-bold md:text2xl text-base pl-3 text-gray-800">Eaglone admin</p>
                                    </div>
                                ...
                                <div className="border-t border-gray-300">
                                    <div className="w-full flex items-center justify-between px-6 pt-1">
                                        <div className="flex items-center">
                                            ...
                                            <p className=" text-gray-800 text-base leading-4 ml-2">Janje Doe</p>
                                        </div>
                                        <ul className="flex">
                    ...
                    <div className="container px-6 justify-between h-16 flex items-center lg:items-stretch mx-auto">
                        <div className="h-full flex items-center">
                            ...
                            <nav className="pr-12 xl:flex items-center h-full hidden">
                                <NavLink className="cursor-pointer h-full flex justify-between items-center text-sm tracking-normal border-b-2  p-5" to="/admin/home">Home</NavLink>
